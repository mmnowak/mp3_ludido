...
| Navigation bar links | Lead to the correct pages | Click on all the links | Redirected to the correct pages ![Nav links](documentation/testing/user-stories/us2a.gif) | Pass |
| Navigation bar links | Change colour on hover | Hover over all the links | Link colour changes ![Nav links](documentation/testing/feature-testing/navlinks.gif) | Pass |
| Navigation bar Logo | Leads to Index Page when clicked | Click on the logo | Index page loads ![Logo](documentation/testing/feature-testing/clicklogo.gif) | Pass |
...
| Footer links | Change colour on hover | Hover over all the links | Icon colour changes ![Footer](documentation/testing/feature-testing/footericons.gif) | Pass |
...
| Action buttons | Lead to the correct pages | Click on the buttons both logged in and out | The correct pages load ![Action buttons](documentation/testing/feature-testing/indexbutton.gif) | Pass |
| Action buttons | Change colour on hover | Hover over the buttons | The colour changes ![Action buttons](documentation/testing/feature-testing/actionbuttons.gif) | Pass |
| Features section images | Correct images appear | Load the Index page | The correct images appear | Pass |
| Features section divs | Increase in size on hover | Hover over the divs | Divs increase in size ![Index features](documentation/testing/feature-testing/indexfeatures.gif) | Pass |
| Features section divs | Lead to correct pages when clicked | Click on the divs both logged in and out | The correct pages load ![features](documentation/testing/feature-testing/features1.gif) ![features](documentation/testing/feature-testing/features2.gif) ![features](documentation/testing/feature-testing/features3.gif) ![features](documentation/testing/feature-testing/features4.gif) | Pass |

**Activities Page**

| **Feature** | **Expected Outcome** | **Testing Performed** | **Result** | **Pass/Fail** |
| --- | --- | --- | --- | --- |
| Add Activity button | Lead to the Add Activity page when clicked | Click on the button | The Add Activity page loads ![add activity](documentation/testing/user-stories/us12a.gif) | Pass |
| Add Activity button | Changes colour on hover | Hover over the button | The button changes colour | Pass |
| My Favourites button | Lead to the Favourites page when clicked | Click on the button | The Favourites page loads ![my favourites](documentation/testing/feature-testing/myfavouritesbutton.gif) | Pass |
...
| See Instructions button | Lead to the correct Full Activity page | Click on the button | Correct pages load ![features](documentation/testing/user-stories/us5b.gif) | Pass |
| See Instructions button | Changes colour on hover | Hover over the button | Button colour changes | Pass |
| Edit button | Lead to the Edit Activity page | Click on the button | Correct page loads ![edit activity](documentation/testing/user-stories/us12c.gif) | Pass |
| Delete button | Opens a modal | Click on the button | Modal opens | Pass |
| Delete Activity modal | Deletes the activity when the Delete button is clicked | Click on the button | The activity is deleted from the DB ![delete](documentation/testing/feature-testing/deleteact.gif) | Pass |
...
| Add Activity form | User occasions apear in dropdown | Click on the occasions dropdown | All occasions appear correctly ![features](documentation/testing/feature-testing/occasionsdropdown.gif) | Pass |
| Add Activity button | Adds a new activity to the DB when clicked | Add a new activity | The new activity is displayed on the Activity page ![add activity](documentation/testing/feature-testing/addactivityfunction.gif) | Pass |
| Add Activity button | Changes colour on hover | Hover over the button | The button changes colour | Pass |
| Flash message | Appears when a new activity is added | Add a new activity | A flash message appears ![flash message](documentation/testing/user-stories/us17a.gif) | Pass |

**Edit Activity Page**

| **Feature** | **Expected Outcome** | **Testing Performed** | **Result** | **Pass/Fail** |
| --- | --- | --- | --- | --- |
| Edit Activity form | All fields display correctly | Load the page | Correct fields appear ![edit activity](documentation/testing/user-stories/us12d.gif) | Pass |
...
| Flash message | Appears when an activity is edited | Edit an activity | A flash message appears ![edit activity](documentation/testing/user-stories/us17b.gif) | Pass |

**Occasions Page**

| **Feature** | **Expected Outcome** | **Testing Performed** | **Result** | **Pass/Fail** |
| --- | --- | --- | --- | --- |
| Add Occasion button | Lead to the Add Occasion page when clicked | Click on the button | The Add Occasion page loads ![add occasion](documentation/testing/feature-testing/addoccasionbutton.gif) | Pass |
...
| Occasion name | Leads to a relevant Activities by Occasion page when clicked | Click on a name | Correct page loads ![activity by occasion](documentation/testing/feature-testing/actbyocc.gif) | Pass |
| Occasion name | Changes colour on hover | Hover over a name | Link changes colour | Pass |
| Edit button | Lead to the Edit Occasion page | Click on the button | Correct page loads ![edit occasion](documentation/testing/feature-testing/editoccasions.gif) | Pass |
| Delete button | Opens a modal | Click on the button | Modal opens | Pass |
| Delete Occasion modal | Deletes the occasion when the Delete button is clicked | Click on the button | The occasion is deleted from the DB ![delete occasion](documentation/testing/feature-testing/occdelete.gif) | Pass |
...
| Flash message | Appears when a new occasion is added | Add a new occasion | A flash message appears ![edit activity](documentation/testing/user-stories/us17d.gif) | Pass |
...
| Edit Occasion form | Name field populated with the correct Occasion name | Load the page | Correct name appears ![edit occasion](documentation/testing/feature-testing/editoccasionsform.gif) | Pass |
...
| Flash message | Appears when an occasion is edited | Edit a occasion | A flash message appears ![edit activity](documentation/testing/user-stories/us17e.gif) | Pass |
...
| See Instructions button | Changes colour on hover | Hover over the button | Button colour changes | Pass |
| Edit button | Lead to the Edit Activity page | Click on the button | Correct page loads ![edit actvity](documentation/testing/feature-testing/editactbyoccasion.gif) | Pass |
| Delete button | Opens a modal | Click on the button | Modal opens ![delete activity](documentation/testing/feature-testing/deleteactbyoccasion.gif) | Pass |
...
| Add to favourites button | Adds an activity to favourites | Click on the button | The activity appears on the Favourite page ![add to favs](documentation/testing/feature-testing/addtofavsbyoccsasion.gif) | Pass |
| Remove from favourites button | Remove the activity from favourites | Click on the button | The activity disappears from the Favourite page | Pass |
...
| Ages cards | Lead to a relevant Activities by Age page when clicked | Click on each card | Correct page loads ![age cards](documentation/testing/feature-testing/agelinks.gif) | Pass |
| Ages cards | Increase in size on hover | Hover over each card | The cards increase in size ![age cards](documentation/testing/feature-testing/agecards.gif) | Pass |
...
| See Instructions button | Lead to the correct Full Activity page | Click on the button | Correct pages load | Pass |
| See Instructions button | Changes colour on hover | Hover over the button | Button colour changes | Pass |
| Edit button | Lead to the Edit Activity page | Click on the button | Correct page loads ![edit](documentation/testing/feature-testing/editactbyage.gif) | Pass |
| Delete button | Opens a modal | Click on the button | Modal opens ![delete](documentation/testing/feature-testing/deletebyages.gif) | Pass |
| Delete Activity modal | Deletes the activity when the Delete button is clicked | Click on the button | The activity is deleted from the DB | Pass |
| Add to favourites button | Adds an activity to favourites | Click on the button | The activity appears on the Favourite page ![add to favs](documentation/testing/feature-testing/addtofavsbyages.gif) | Pass |
| Remove from favourites button | Remove the activity from favourites | Click on the button | The activity disappears from the Favourite page | Pass |
